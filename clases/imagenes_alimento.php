<?php
	...
	class Imagenes_alimento extends raiz{
		
		private $imagen;
		private $tImg;	//total de imagenes alimentos
		...
		public function TotalImagenes(){
			...
			$enlace=parent::Conectar();
			$query = "select count(*) as total from tblplantillaalimentos";
			$result = mysqli_query($enlace,$query);
